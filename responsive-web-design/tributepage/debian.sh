...
function CheckVersionOS {
    ...
    case ${ID} in
        debian )    export FAMILY='debian'
                    case ${VERSION_ID} in
                        8 )             export OS='jessie'
                                        export AVAILABLE_MYSQL_VERSIONS='default|mariadb10.2|mariadb10.3|mariadb10.4|mysql5.6|mysql5.7|percona5.6|percona5.7'
                        ...
                        9 )             export OS='stretch'
                                        ...
                                        ;;
                        10 )            export OS='buster'
                                        export AVAILABLE_MYSQL_VERSIONS='default|mariadb10.2|mariadb10.3|mariadb10.4|mariadb10.5|mysql5.7|mysql8.0'
                                        export MYSQL_VERSION='mysql5.7'
                                        ;;
                        11 )            export OS='bullseye'
                                        export AVAILABLE_MYSQL_VERSIONS='default|mariadb10.5|mysql8.0'
